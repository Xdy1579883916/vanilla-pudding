...
export declare function extRequest(type: MethodType, url: string, config?: AlovaMethodCreateConfig<unknown, unknown, FetchRequestInit, Headers>, data?: RequestBody): Method<unknown, unknown, unknown, unknown, FetchRequestInit, Response, Headers>;
...
export declare class BackgroundToolService {
    ...
    cookieGetAll(option: chrome.cookies.Details): Promise<chrome.cookies.Cookie[]>;

    cookieSet(option: chrome.cookies.Details): Promise<chrome.cookies.Cookie>;
